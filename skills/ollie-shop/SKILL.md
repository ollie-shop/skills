...
- **Customization tooling lives in the customer's repo under `.claude/skills/ollie-shop/`** (managed by Ollie, replaced on update). Anything outside that directory is the customer's own and is never touched by tooling sync.
