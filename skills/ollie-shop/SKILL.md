...
- **Complexity rules** (`references/complexity-validation-rules.md`) apply to all components, functions, and actions — keep useState ≤2, useEffect ≤1, booleans ≤2, functions ≤30 lines. These rules prevent cognitive overload and ensure code stays maintainable.
