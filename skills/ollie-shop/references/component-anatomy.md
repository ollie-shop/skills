...
> The historical convention was `index.module.css`; the current convention is `index.module.css` (matches the entry file's name, groups the folder alphabetically). Both still work at the bundler level — use `index.module.css` for new code.
