...
```bash
ollieshop component create --version-id <uuid> --name FreeShippingBar --slot cart_header_full_page --props '{"thresholdCents":19900}'
```
...
ollieshop component create --version-id <version-id> --name FreeShippingBar --slot cart_header_full_page
