...
**The authoritative slot list for this template lives in [`references/slots-catalog.md`](../slots-catalog.md)**, with the machine-readable copy in [`assets/slots.json`](../../assets/slots.json). Both are scoped to `template: "default"` — other templates would publish their own catalog.
